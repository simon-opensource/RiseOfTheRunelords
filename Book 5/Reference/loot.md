# Sins of the Saviors Loot (Levels 13-15)

- Level 13: Part 1 (The Scribbler) + Part 2 (Seeking Runeforge / Dragon Hoard)
- Level 14: Parts 3-8 (Runeforge wings)
- Level 15 (first half): Part 9 (Halls of Wrath) + Part 10 (Weapons of Power)
...
Lv15.5| 28,875gp | **16th:** 1 **15th:** 2 | **16th:** 1 **15th:** 2 **14th:** 1 | 8,125gp | 9, 10

[Full Level to Wealth Chart](http://2e.aonprd.com/Rules.aspx?ID=581)

**Notes:**
- Spellbooks are listed but do NOT count against the budget (valued at 50% of learn-a-spell cost for reference).
- Story items (Revelation Quill, Dominant Weapon) do NOT count against the budget.
- Bulk warrior/sinspawn equipment (well below party level) counts at half price toward currency.
- All item names use PF2e Remaster terminology.

---

## Part 1: The Scribbler (Party Level 13)

### The Scribbler

- **Creatures:** The Scribbler
- **Loot:**
  - [Fanged Falchion](../Statblocks/fanged_falchion-1608756957.pdf) (custom, treat as **Level 14** permanent item) — 4,500gp
  - +1 [returning](https://2e.aonprd.com/Equipment.aspx?ID=301) [cold iron](https://2e.aonprd.com/Equipment.aspx?ID=375) dagger (low-grade cold iron +1 striking returning dagger) — **Level 4** base, effectively ~200gp value. Count as currency: **200gp**
  - +2 resilient breastplate — **Level 11**, 1,400gp. Below level; count as currency: **700gp**
  - 75gp diamond dust (1e: 750gp / 10)
...
- **Loot:**
  - 17 vials of ink — 5gp
  - Revelation Quill (Artifact, Item 20) — **story item, does not count against budget**

---

## Part 2: Seeking Runeforge (Party Level 13)

### C5 Dragon Hoard (Arkrhyst)

The hoard of the white dragon Arkrhyst is an enormous pile of coins, art objects, and magic items accumulated over centuries. It fills a large chamber, and searching it thoroughly takes over an hour.

- **Creatures:** Arkrhyst (ancient white dragon)
- **Loot:**

**Coins** (1e total ~7,336gp; converted ~730gp):
  - Mixed coinage (copper, silver, gold, platinum) — **730gp**

**Art Objects** (1e: 15,670gp; converted ~1,500gp):
...
**Permanent Items:**
  ...
  - [Duskwood Shield](https://2e.aonprd.com/Equipment.aspx?ID=2815) (standard-grade buckler with Kyonin symbol) — **Level 8**, 440gp. Count as currency: **220gp**
  - [Wand of Shardstorm](https://2e.aonprd.com/Equipment.aspx?ID=3052) (3rd-rank, replaces wand of magic missile CL5) — **Level 13** permanent item, 3,000gp *(useful for Squeaks or Ka'ata)*
  - [Wand of Crackling Lightning](https://2e.aonprd.com/Equipment.aspx?ID=3424) (3rd-rank, replaces wand of lightning bolt CL10) — **Level 14** permanent item, 4,500gp *(useful for Ka'ata or Squeaks)*
  - +2 [greater striking](https://2e.aonprd.com/Equipment.aspx?ID=2829) runestone (loose rune, found on the haft of a shattered halberd; replaces +1 adamantine warhammer — upscaled for 2e budget) — **Level 12**, 2,000gp. Count as **Level 13** permanent item. *(Critical for Grimace — apply to his Dorn-Dergar)*
  - +2 [resilient](https://2e.aonprd.com/Equipment.aspx?ID=2786) full plate (wolf motif, from a fallen champion; replaces +3 half-plate — re-themed as full plate for party use) — **Level 11**, 1,400gp. Count as currency at half: **700gp** *(Grimace can transfer the resilient rune to his existing full plate, or wear this one outright)*
  - Masterwork full plate with onyx ravens (decorative; the 12 ravens are worth 20gp each) — **240gp** in art value
  - +1 [flaming](https://2e.aonprd.com/Equipment.aspx?ID=2838) [striking](https://2e.aonprd.com/Equipment.aspx?ID=2829) longsword (replaces flame tongue) — **Level 8**, 600gp. Count as currency: **300gp**
  - +1 striking adamantine warhammer (standard-grade) — **Level 11**, 100gp (weapon) + 1,400gp (adamantine) = 1,500gp. Count as currency: **750gp**
  - 2x small [dawnsilver](https://2e.aonprd.com/Equipment.aspx?ID=2799) chain shirts (standard-grade; replaces mithral) — **Level 12**, 1,600gp each. Count as currency at half: **1,600gp** total
  - [Cloak of the Bat](https://2e.aonprd.com/Equipment.aspx?ID=425) (from a slain infiltrator; replaces cloak of resistance +3) — **Level 10**, 900gp. Count as currency: **450gp** *(useful for Jinichi or Mokuzai)*
  - [Charm of Resistance (Greater, cold)](https://2e.aonprd.com/Equipment.aspx?ID=3065) (replaces bracers of archery — re-themed for a dragon's frozen lair) — **Level 10**, 1,000gp. Count as currency: **500gp** *(useful for anyone heading into cold environments)*

**Wands (converted to limited items):**
  - [Wand](https://2e.aonprd.com/Equipment.aspx?ID=368) of [Heal](https://2e.aonprd.com/Spells.aspx?ID=1547) (rank 3) (replaces wand of CLW 46ch) — **Level 7**, 500gp. Count as currency: **250gp**
...
## Part 3: The Abjurant Halls (Party Level 14)
...
## Part 4: The Ravenous Crypts (Party Level 14)

### F3 Crypt of Lord Mankray

- **Creatures:** Elite Clay Golem
- **Loot:**
...
## Part 5: The Vault of Greed (Party Level 14)

### G1 Pilferer's Bane

- **Creatures:** Crushing Door Trap (hazard)
- **Loot:**
  - Colorful gemstones — **50gp**

### G6 Research Center (Ordikon)

- **Creatures:** Ordikon, the Mithral Mage
- **Loot:**
...
- **Creatures:** Zuzuveg (demon)
- **Loot:**
  - Golden statues — non-portable; the gold reverts to base metal outside the wing. Worth nothing.

---

## Part 6: The Iron Cages of Lust (Party Level 14)
...
- **Creatures:** Enslaved Cloud Giants
- **Loot:**
  - 5 greatclubs — negligible (giant-sized)

### H7 Delvahine's Chambers

- **Creatures:** Delvahine
- **Loot:**
  - [Sadist's Lash](../Statblocks/delvahine-1608760521.pdf) (+2 wounding whip, custom) — treat as **Level 14** permanent item, 4,500gp
...
## Part 7: The Shimmering Veils (Party Level 14)
...
- **Creatures:** None (Vraxeris's original corpse)
- **Loot:**
...
## Part 8: The Festering Maze (Party Level 14)
...
- **Creatures:** Jordimandus
- **Loot:**
  - [Rod of Negation](https://2e.aonprd.com/Equipment.aspx?ID=264) — replaces rod of absorption (closest 2e equivalent). **Level 14** permanent item, 4,300gp
  - [Spacious Pouch (Type II)](https://2e.aonprd.com/Equipment.aspx?ID=3032) — replaces handy haversack. Level 7, 300gp. Count as currency: **150gp**
  - 50gp diamond dust (1e: 500gp / 10)
  - Ivory plaque — 5gp (1e: 50gp / 10)
...
## Part 9: The Halls of Wrath (Party Level 15, first half)
...
- **Creatures:** Warriors of Wrath + Sinspawn Axemen (total = 150% of party size)
- **Loot (bulk equipment, well below party level — all at half value toward currency):**
  - 6x +1 striking greatsword (warriors) — Level 4, 100gp each. Half value: **300gp**
...
- **Creatures:** Warriors/Alchemists of Wrath (1 per PC)
- **Loot (bulk equipment, as above):**
  - 9x +1 striking greatsword (sinspawn) — half value total: **450gp**
  - 9x +1 resilient breastplate (sinspawn) — half value total: **2,250gp**
  - *Capped at **1,500gp** for budget (same reasoning as K3).*

### K5 Chamber of Readiness

- **Creatures:** None (weapons embedded in walls; Athletics DC 30 or [Stone to Flesh](https://2e.aonprd.com/Spells.aspx?ID=311) to extract)
- **Loot:**
  - 2x +1 striking greatsword — Level 4, 100gp each. Count as currency: **100gp**
  - 2x +1 striking ranseur — Level 4, 100gp each. Count as currency: **100gp**
  - 2x +1 striking longsword — Level 4, 100gp each. Count as currency: **100gp**

### K6 Hall of Testing (Highlady Athroxis)

- **Creatures:** Highlady Athroxis + Glabrezu
- **Loot:**
...
## Part 10: Weapons of Power (Party Level 15)

- **Creatures:** Karzoug Golem
- **Loot:**
  - Dominant Weapon (forged by PCs) — **story item, does not count against budget**
...
## - End of RotR Sins of the Saviors Treasure Allocation -
